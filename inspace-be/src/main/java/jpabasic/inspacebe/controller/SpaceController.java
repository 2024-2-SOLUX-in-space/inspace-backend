...
public class SpaceController {
    ...
    public ResponseEntity<SpaceDto> createSpace(@Valid @RequestBody SpaceDto spaceDto, @PathVariable int user_id){
...
//    public ResponseEntity<List<SpaceDto>> getSpaces(@PathVariable int user_id){
//        List<SpaceDto> spaces=spaceService.getSpaces(user_id);
//        return new ResponseEntity<>(spaces, HttpStatus.OK);
//    }

    //예외처리해야.
    @GetMapping("/spaces/{space_id}")
    @Operation(summary="특정 공간 조회")
    public ResponseEntity<SpaceDto> getSpace(@PathVariable int space_id){
    ...
    public ResponseEntity<SpaceDto> updateSpace(@PathVariable int space_id, @Valid @RequestBody SpaceDto spaceDto){
